...
namespace SSO.Util
{
    public class WebUtils
    {
        ...
        /// <summary>
        /// 获取当前host 例如：http://192.168.1.168：8888
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// 递归UrlDecode ps:有的url被多次encode 通过此方法可以完全decode
        /// </summary>
        /// <param name="url"></param>
        /// <returns></returns>
        public static string UrlDecode(string url)
        {
            if (!url.StartsWith("http")) return  HttpUtility.UrlDecode(url);
            if (url.StartsWith("http://")) return url;
            var str = HttpUtility.UrlDecode(url);
            if (str == null) return "";
